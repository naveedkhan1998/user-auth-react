...
{/*   {server_error.name? console.log(server_error.name[0]):''}
  ...
  <Box component='form' noValidate sx={{mt:1}} id="registration-form" onSubmit={handleSubmit}>
        ...
        label='Full Name' />
        {server_error.name?<Typography style = {{fontSize:12,
            color:'red',paddingLeft:'10'}}>{server_error.name[0]}</Typography>:''}
        <TextField margin='normal' required fullWidth id='email' name='email'
        label='Email Address' />
        {server_error.email?<Typography style = {{fontSize:12,
            color:'red',paddingLeft:'10'}}>{server_error.email[0]}</Typography>:''}
        ...
        {server_error.tc?<span style = {{fontSize:12,
            color:'red',paddingLeft:'10'}}>{server_error.tc[0]}</span>:''}
