...
{/*   {server_error.name? console.log(server_error.name[0]):''}
  ...
  <Box>
    {!otp_generated?
        <Box component='form' noValidate sx={{mt:1}} id="send-otp-form" onSubmit = {handleOTP}>
            <TextField margin='normal' required fullWidth id='email_otp' name='email_otp'
            label='Email Address' />
        ...
        <Box component='form' noValidate sx={{mt:1}} id="registration-form" onSubmit={handleSubmit}>
            ...
            <TextField margin='normal' required fullWidth id='otp' name='otp'
            label='OTP' type='otp' />
